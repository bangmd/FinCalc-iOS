...
| **Bearer Token**         | Автоподстановка токена авторизации ко всем запросам.       |
| **Фоновая сериализация** | Распарс JSON / CSV на фоне, не блокируя UI.                |
| **Прокидывание ошибок**  | Корректная обработка HTTP‑кодов, локализованные сообщения. |
